	    ...
	    <div class="panel-body">
	    	<form id="add-form" method="post">
				<div class="col-sm-5 col-sm-offset-3 my-from-group">
					...
					<input type="text" class="form-control" name="name" value="${fn:escapeXml(module.name)}" maxlength="10" placeholder="请输入名称">
					<span class="my-required"></span>
				</div>
				<div class="col-sm-4 my-error"></div>
				<div class="col-sm-5 col-sm-offset-3 my-from-group">
					<label class="control-label">路径</label>
					<input type="text" class="form-control" value="${fn:escapeXml(module.url)}" name="url" maxlength="100" placeholder="请输入路径">
					<span class="my-required"></span>
				</div>
				<div class="col-sm-4 my-error"></div>
