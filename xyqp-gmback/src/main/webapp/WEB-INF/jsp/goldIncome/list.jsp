...
<div class="my-content">
	<div class="panel panel-default">
	    <div class="panel-heading">
	        <h3 class="panel-title">金币返利</h3>
	    </div>
	    <div class="panel-body">
	    	<form id="search-form">
				<div class="col-sm-4 my-from-group">
					<label class="control-label">开始时间</label>
					<input type="text" name="startTime" class="form-control" value='<fmt:formatDate value="${goldConsumeQuery.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>' onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="开始时间" >
				</div>
				<div class="col-sm-4 my-from-group">
					<label class="control-label">结束时间</label>
					<input type="text" name="endTime" class="form-control" value='<fmt:formatDate value="${goldConsumeQuery.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>' onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="结束时间" >
				</div>
				<div class="col-sm-4 my-from-group">
					<label class="control-label">用户编号</label>
					<input type="number" name="consumerId" class="form-control" value="${fn:escapeXml(goldConsumeQuery.consumerId)}" placeholder="请输入用户编号">
				</div>
				<div class="col-sm-4">
		...
		<table class="table table-bordered my-table">
			...
			<tr>
				...
				<td>${element.consumerId}</td>
				<td>${fn:escapeXml(element.consumerName)}</td>
				<td>${element.consumeGole}</td>
